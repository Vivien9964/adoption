        ...
        <>
            ...
            <Section padding="large" background="gray">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 md:gap-8">
                    ...
                    {/* Profile card */}
                    {/* Grouping container - relative positioning for the badge later on */}
                    <div className="group relative cursor-pointer">
                        ...
                        <div className="text-center bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 ">
                            ...
                            <div className='flex justify-center -mt-16 mb-4'>
                                <div className='relative'>
                                    <div className='h-32 w-32 rounded-full border-4 border-white shadow-xl overflow-hidden'>
                                        <img src="/images/AdoptStepOne.jpg" className='h-full w-full object-cover' alt="" />
                                    </div>
                                </div> 
                            </div>
                            ...
                            <div className='px-6 pb-6 text-center'>
                                <h1 className='mb-2 text-4xl font-bold text-gray-800'>Luna</h1>
                            </div>
                            ...
                            <div className='grid grid-cols-3 gap-3 mb-4 p-3'>
                                ...
                                <div className='text-center p-3 bg-yellow-200 border-2 border-gray-700 rounded-2xl'>
                                    ...
                                    <p className='text-lg leading-tight font-bold text-gray-800'>Collie</p>
                                </div>

                                {/* Age container */}
                                <div className='text-center p-3 bg-yellow-200 border-2 border-gray-700 rounded-2xl'>
                                    <p className='mb-1 text-xs tracking-wide font-semibold uppercase text-yellow-900/70'>Age</p>
                                    <p className='text-lg leading-tight font-bold text-gray-800'>2 years</p>
                                </div>

                                {/* Gender container */}
                                <div className='text-center p-3 bg-yellow-200 border-2 border-gray-700 rounded-2xl'>
                                    <p className='mb-1 text-xs tracking-wide font-semibold uppercase text-yellow-900/70'>Gender</p>
                                    <p className='text-lg leading-tight font-bold text-gray-800'>Female</p>
                                </div>
                            ...
                            {/* Dog description */}
                            <p className='mb-5 px-2 text-gray-600 text-sm text-center leading-relaxed'>Luna is and adorable Border Collie who loves to play outside.</p>                        
